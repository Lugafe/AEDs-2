...
public class Q1TP3 {
   ...
   public static void main(String[] args) throws Exception {
      ...
      do {
         if (!s.equalsIgnoreCase("FIM")) {
            ...
            if (i == 0) {
               Celula n = new Celula(p);
               personagens2 = new Lista(n);               
               i++;
            } else {
      ...
      for (int j = 0; j <= c; j++) {
         ...
         switch (sp[0]) {
            ...
            case "IF":
               ...
               break;
            case "RI":
               System.out.println("(R) " + personagens2.removerInicio().getName());
               break;
            case "R*":
               System.out.println("(R) " + personagens2.remover(Integer.parseInt(sp[1])).getName());
               break;
            case "RF":
               System.out.println("(R) " + personagens2.removerFim().getName());
   ...
   public static Lista arquivo() throws Exception {
      ...
      Lista personagens = new Lista();
      Personagem p = new Personagem();int i = 0;
      // String line;
      try {
...
class Personagem {
   ...
   public void imprimir(int x) {
      ...
      System.out
            .println("["+x+" ## " + this.id + " ## " + this.name + " ## " + this.alternate_names + " ## " + this.house + " ## "
