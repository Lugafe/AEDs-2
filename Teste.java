...
class Lista {
    ...
    public void construir(int tamHeap){
        for(int i = tamHeap; i > 1 && array[i].getHairColour().compareTo(array[i/2].getHairColour()) > 0; i /= 2){
           swap(i, i/2);
        }
     }
     ...
     public void reconstruir(int tamHeap){
        ...
        while(i <= (tamHeap/2)){
           ...
           if(array[i].getHairColour().compareTo(array[filho].getHairColour()) < 0){
              swap(i, filho);
              i = filho;
           }else{
              i = tamHeap;
     ...
     public int getMaiorFilho(int i, int tamHeap){
        int filho;
        if (2*i == tamHeap || array[2*i].getHairColour().compareTo(array[2*i+1].getHairColour()) > 0){
           filho = 2*i;
        } else {
           filho = 2*i + 1;
        }
